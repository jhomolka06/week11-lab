...
/* Looking at the HTML file, you can observe that Question 1 has a DIV, an INPUT, and a BUTTON. The BUTTON is programmed to call a function called "" on the event of a click. 
...
/* In the HTML file, there is an image of a dog in the DIV with a class name of "dog".  You will programmatically add 2 more images, one before the dog DIV and another image after the dog DIV.
	* Step 1: Insert a DIV element with an IMAGE nested inside BEFORE the dog DIV. The image should be: <>.(See documentation: https://api.jquery.com/before/)
	* Step 2: Insert a DIV element with an IMAGE nested inside BEFORE the dog DIV. The image should be:<>. (See documentation: https://api.jquery.com/after/)
...
$(".dog").before("<div><img src='images/cat.png' width='200'></div>");
